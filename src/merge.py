...
class Merge(nn.Module):
    ...
    def forward(
        self,
        point_embedding_list: Tensor,
        pc_embedding_list: Tensor,
        pc_pe_list: Tensor
    ) -> Tuple[Tensor, Tensor]:
        """
        Args:
        ...
        """
        output_pc_embedding_list = []
        output_point_embedding_list = []

        for pc_embedding, pc_pe, point_embedding in zip(pc_embedding_list, pc_pe_list, point_embedding_list):
            # Prepare queries
            queries = point_embedding
            keys = pc_embedding

            # print("queries", queries.shape) # Shape -> 7, 10, 256
            # print("keys", keys.shape) # Shape -> 7, 512, 256
            ...
            output_pc_embedding_list.append(keys)
            output_point_embedding_list.append(queries)

        return output_pc_embedding_list, output_point_embedding_list
