...
data_root = "/media/thor/92ec5e88-e6fe-41ad-9bce-b046bbbac293/Datasets/Lidar_Segmentation/ScanNet"
...
data = dict(
    ...
    val=dict(
        ...
        transform=[
            ...
            dict(
                type="Collect",
                keys=("coord", "grid_coord", "color", "normal", "point", "masks", "condition", "domain", "mask_labels", "segment"),
            ),
        ],
        test_mode=False,
    )
