...
data_root = "/projects/nufr/aniket/Datasets/UrbanBIS"
...
data = dict(
    train=dict(
        ...
        transform=[
            ...
            dict(type="Add", keys_dict={"condition": "UrbanBIS"}),
            dict(type="Add", keys_dict={"domain": "Aerial"}),
            dict(type="ToTensor"),
            dict(
                type="Collect",
                keys=("coord", "color", "grid_coord", "point", "masks", "condition", "domain", "mask_labels"),
            ),
        ],
        test_mode=False,
    ),
